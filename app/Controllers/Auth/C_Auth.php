...
use App\Models\Shared\M_Mahasiswa;
use App\Models\Mahasiswa\M_User_Mahasiswa;
use App\Models\Shared\M_InstansiMahasiswa; 
use App\Models\Shared\M_InstansiPendidikan; 
...
class C_Auth extends C_Base
{
    ...
    public function __construct()
    {
        ...
        $this->mahasiswaModel          = new M_Mahasiswa_Mahasiswa();
        $this->userMahasiswaModel      = new M_User_Mahasiswa();
        $this->instansiMahasiswaModel  = new M_InstansiMahasiswa_Mahasiswa();
        $this->instansiPendidikanModel = new M_InstansiPendidikan_Mahasiswa();
    }
    ...
    public function register()
    {
        ...
        return view('auth/V_Register_Auth', $data);
    }
  ...
  // --- PROSES SUBMIT REGISTRASI MAHASISWA DENGAN VALIDASI CI4 CUSTOM ---
    ...
    public function login()
    {
        ...
        return view('auth/V_Login_Auth', $data);
    }
   ...
   // --- VERIFIKASI LOGIN OTOMATIS (DETEKSI MULTI-ACTOR KEDINASAN + VALIDASI CI4) ---
    ...
    public function loginPegawai()
    {
        ...
        return view('auth/V_LoginPegawai_Auth', $data);
    }
