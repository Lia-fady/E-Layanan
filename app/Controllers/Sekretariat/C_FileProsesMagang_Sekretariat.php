...
class C_FileProsesMagang_Sekretariat extends BaseController
{
    protected $fileModel;
    ...
    public function store()
    {
        ...
        if ($file->isValid() && !$file->hasMoved()) {
            ...
            // Path: writable/uploads/surat_penerimaan_magang/
            // Note: In CI4, if you want it publicly accessible, you might need a route to serve it or move it to public. 
            // The prompt asks to save in writable/uploads/surat_penerimaan_magang/ and path as uploads/surat_penerimaan_magang/...
