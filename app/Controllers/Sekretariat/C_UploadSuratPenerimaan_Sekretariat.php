...
class C_UploadSuratPenerimaan_Sekretariat extends C_Base
{
    protected $fileModel;
    ...
    public function index()
    {
        if ($this->request->isAJAX() && $this->request->getPost('action') === 'get_detail') {
            ...
            return view('sekretariat/V_UploadSuratPenerimaanDetail_Sekretariat', $data);
        }
        ...
        return view('sekretariat/V_UploadSuratPenerimaanIndex_Sekretariat', $data);
    }
