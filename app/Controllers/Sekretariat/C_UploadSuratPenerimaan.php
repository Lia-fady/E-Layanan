...
class C_UploadSuratPenerimaan extends BaseController
{
    ...
    public function create($id_persetujuan)
    {
        ...
        if (!$persetujuan) {
            return redirect()->to(base_url('sekretariat/upload-surat-penerimaan'))->with('error', 'Data persetujuan tidak ditemukan.');
        }
        ...
        return view('dashboard/sekretariat/v_upload_surat_penerimaan', $data);
    }
