...
class C_Verifikasi_Sekretariat extends C_Base
{
    ...
    public function index()
    {
        ...
        if ($this->request->isAJAX() && $this->request->getPost('action') === 'get_detail') {
            ...
            return view('sekretariat/V_VerifikasiDetail_Sekretariat', $data);
        }
        ...
        return view('sekretariat/V_VerifikasiIndex_Sekretariat', $data);
    }
