...
class C_Logbook_Mahasiswa extends C_Base_Mahasiswa
{
    public function logbook()
    {
        ...
        if (!empty($semuaPenempatan)) {
            // Default to the first (latest) placement, unless specified in URL
            $penempatan = $semuaPenempatan[0];
            $req_id_penempatan = $this->request->getGet('id_penempatan');
        ...
        if ($penempatan) {
            ...
            $riwayatLogbook = $builder->orderBy('tgl_logbook', 'DESC')->paginate(10, 'logbook');
        }
        ...
        return view('mahasiswa/V_RiwayatLogbook_Mahasiswa', $data);
    }
    ...
    public function simpanLogbook()
    {
        ...
        return redirect()->to(base_url('mahasiswa/logbook?id_penempatan=' . $id_penempatan_post))->with('success', 'Logbook harian berhasil disimpan!');
    }
    ...
    public function cetakLogbook()
    {
        ...
        return view('mahasiswa/V_CetakLogbook_Mahasiswa', $data);
    }
}
