...
$routes->group('kabid', ['filter' => 'authKabid'], static function ($routes) {
    ...
    $routes->get('profile', '\App\Controllers\Kabid\C_Profile::index');
    $routes->post('profile/update', '\App\Controllers\Kabid\C_Profile::update');
    ...
    $routes->post('upload-dokumen/store-multi', '\App\Controllers\Kabid\C_UploadDokumen::storeMulti');
