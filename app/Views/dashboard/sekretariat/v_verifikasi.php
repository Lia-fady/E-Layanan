                ...
                <tr data-filter-status="<?= $status ?>">
                    ...
                    <td class="text-center align-middle">
                        <?php
                            ...
                            $badgePn = 'badge badge-secondary';
                            $label_pn = 'Belum Diverifikasi';

                            // Tampilkan status Bidang hanya jika Sekretariat sudah menyetujui
                            if ($status == 'DISETUJUI') {
                                if ($raw_status_pn == 'BERJALAN') {
                                    ...
                                    else $badgePn = 'badge badge-primary';
