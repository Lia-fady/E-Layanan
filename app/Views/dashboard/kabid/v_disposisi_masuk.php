        ...
        <div class="modal-content" style="border: none; border-radius: 14px; overflow: hidden; box-shadow: 0 8px 32px rgba(15,23,42,0.12);">
            ...
            <div class="modal-body p-0" style="background: #fff;">
                <div style="padding: 1.75rem;">
                    ...
                    <!-- Peringatan Kuota -->
                    <div id="kuota_warning_container" style="display: none;" class="alert alert-warning mb-4" style="border-radius: 8px; font-size: 0.95rem;">
                        <i class="fas fa-exclamation-triangle mr-2"></i> <span id="kuota_warning_text"></span>
                    </div>
...
$(document).ready(function() {
    ...
    $('.btn-detail').on('click', function() {
        ...
        if (mhs.kuota_warning) {
            $('#kuota_warning_text').html(mhs.kuota_warning);
            $('#kuota_warning_container').slideDown();
        } else {
            $('#kuota_warning_container').hide();
        }
