...
<div id="sectionList">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h5 style="font-weight:700; color:#1B2559; margin-bottom:4px;">Riwayat Penempatan</h5>
            <p style="color:#667085; font-size:0.85rem; margin:0;">
                Lihat riwayat permohonan yang telah Anda setujui atau tolak.
            </p>
        </div>
    </div>
    <?= $this->include('dashboard/kabid/riwayat/_list') ?>
</div>
...
$(document).ready(function() {
    var table = $('#dataTableCustom').DataTable({
        ...
        "responsive": true,
        "language": {
            "emptyTable": "Belum ada riwayat disposisi.",
...
function renderLogTimelineKabid(logs) {
    ...
    logs.forEach(function(log, index) {
        ...
        html += '<div class="flex-shrink-0 mr-3 ' + bgClass + ' ' + textClass + '" style="width: 32px; height: 32px; border-radius: 50%; display: flex; align-items: center; justify-content: center; font-size: 0.8rem; box-shadow: 0 0 0 4px #f8f9fa; z-index: 2;">';
