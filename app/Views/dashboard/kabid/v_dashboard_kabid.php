...
<div class="row mb-4">
        ...
        <div class="card stat-card h-100 bg-white">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-start mb-2">
                    <div class="rounded p-2" style="background-color: #FEF3C7; color: #D97706; font-size: 1rem;">
                        📥
                    </div>
                </div>
                <div class="stat-title mt-3">DISPOSISI MASUK</div>
                <div class="d-flex align-items-baseline" style="gap: 8px;">
                    <div class="stat-number"><?= $total_menunggu ?></div>
                    <div class="stat-desc">Jumlah Menunggu</div>
                </div>
                <div class="stat-desc mt-2">🟡 Menunggu Review</div>
            </div>
        </div>
    </div>
    ...
    <div class="col-xl-3 col-md-6 mb-3">
        <div class="card stat-card h-100 bg-white">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-start mb-2">
                    <div class="rounded p-2" style="background-color: #DBEAFE; color: #2563EB; font-size: 1rem;">
                        👨‍🎓
                    </div>
                </div>
                ...
                <div class="d-flex align-items-baseline" style="gap: 8px;">
                    ...
                    <div class="stat-desc">Jumlah Sedang Berjalan</div>
                </div>
                <div class="stat-desc mt-2">🔵 Sedang Berjalan</div>
            </div>
        </div>
    </div>
    ...
    <div class="col-xl-3 col-md-6 mb-3">
        <div class="card stat-card h-100 bg-white">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-start mb-2">
                    <div class="rounded p-2" style="background-color: #DCFCE7; color: #16A34A; font-size: 1rem;">
                        🎓
                    </div>
                </div>
                <div class="stat-title mt-3">SELESAI MAGANG</div>
                <div class="d-flex align-items-baseline" style="gap: 8px;">
                    <div class="stat-number"><?= $total_selesai ?></div>
                    <div class="stat-desc">Jumlah Selesai</div>
                </div>
                <div class="stat-desc mt-2">🟢 Telah Lulus</div>
            </div>
        </div>
    </div>
    ...
    <div class="col-xl-3 col-md-6 mb-3">
        <div class="card stat-card h-100 bg-white">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-start mb-2">
                    <div class="rounded p-2" style="background-color: #FCE7F3; color: #BE185D; font-size: 1rem;">
                        📊
                    </div>
                </div>
                <div class="stat-title mt-3">SISA KUOTA BIDANG</div>
                <div class="d-flex align-items-baseline" style="gap: 8px; flex-wrap: wrap;">
                    <div class="stat-number" style="font-size: 1.4rem;"><?= $sisa_kuota ?> / <?= $total_kuota ?></div>
                    <div class="stat-desc">Sisa Kuota / Total Kuota</div>
                </div>
                <div class="stat-desc mt-2"><?= esc($kuota_label) ?></div>
            </div>
        </div>
    </div>
</div>
                            ...
                            <div class="d-flex flex-column">
                                <div class="d-flex justify-content-between align-items-center mb-1">
                                    ...
                                    <span style="font-size: 0.75rem; font-weight: 600; color: #1E40AF; background-color: #DBEAFE; padding: 2px 6px; border-radius: 4px;">
                                        <?= esc(date('d M Y', strtotime($log->tgl_logbook ?? null))) ?>
                                    </span>
                                </div>
