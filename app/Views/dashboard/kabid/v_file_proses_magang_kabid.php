...
<!-- Back Link -->
<a href="<?= base_url('kabid/penempatan') ?>" class="detail-back-link mb-4 d-inline-block">
    <i class="fas fa-arrow-left"></i> Kembali ke Daftar Penempatan
</a>
...
<div class="row">
    ...
    <div class="col-lg-4 mb-4">
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <form action="<?= base_url('kabid/file-proses-magang/store') ?>" method="POST" enctype="multipart/form-data">
                    <?= csrf_field() ?>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <div class="d-flex justify-content-center" style="gap: 5px;">
                                            <a href="<?= base_url('kabid/file-proses-magang/download/' . $f->id_file_selesai_magang) ?>" class="btn btn-sm btn-success" title="Download">
...
$(document).ready(function() {
    $('.btn-ganti-file').on('click', function() {
        ...
        $('#formGantiFile').attr('action', '<?= base_url('kabid/file-proses-magang/update/') ?>' + idSelesai);
