...
<?= $this->section('title') ?><?= esc($title ?? 'fakultas create') ?><?= $this->endSection() ?>
...
<section class="content">
    <div class="container-fluid">
        <div class="card shadow-sm">
            ...
            <form id="formTambah" action="<?= base_url('superadmin/fakultas/store') ?>" method="post">
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-8">
                            <div class="mb-3">
            ...
            success: function(response) {
                if(response.success) {
                    Swal.fire({
                        ...
                        window.location.href = "<?= base_url('superadmin/fakultas') ?>";
                    });
                } else {
                    Swal.fire({
                        icon: 'error',
