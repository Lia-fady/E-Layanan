...
<?= $this->section('title') ?><?= esc($title ?? 'fakultas edit') ?><?= $this->endSection() ?>
                    ...
                    <div class="row">
                        <div class="col-lg-8">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="nama_fakultas" name="nama_fakultas" placeholder="Masukkan Nama Fakultas" value="Contoh Data Nama Fakultas" required>
