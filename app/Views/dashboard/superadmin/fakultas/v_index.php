                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-striped table-hover align-middle">
                        ...
                        <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="col-aksi">
                                            <div class="d-flex gap-1 justify-content-center">
                                                <a href="<?= base_url('superadmin/fakultas/edit/' . $row['id_fakultas']) ?>" class="btn btn-sm btn-warning text-white" title="Edit"><i class="fas fa-edit"></i></a>
                                                <button type="button" class="btn btn-sm btn-danger btn-hapus" data-id="<?= $row['id_fakultas'] ?>" data-bs-toggle="modal" data-bs-target="#deleteModal" title="Hapus"><i class="fas fa-trash"></i></button>
                                            </div>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                            <?php else : ?>
                                <tr>
                                    <td colspan="5" class="text-center">Belum ada data fakultas.</td>
                                </tr>
                            <?php endif; ?>
                        </tbody>
                    </table>
