...
<?= $this->section('title') ?><?= esc($title ?? 'user_mahasiswa detail') ?><?= $this->endSection() ?>
...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0">Detail User Mahasiswa</h1>
            </div>
            <div class="col-sm-6">
    ...
    <div class="container-fluid">
        <div class="card shadow-sm">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h3 class="card-title mb-0"><i class="fas fa-info-circle me-2 text-info"></i> Informasi Lengkap User Mahasiswa</h3>
                <div class="card-tools ms-auto">
                    <a href="<?= base_url('superadmin/user-mahasiswa/edit/1') ?>" class="btn btn-success btn-sm">
                ...
                <div class="row">
                    <div class="col-md-8">
                        <table class="table table-borderless table-sm">
                            <tbody>
                                <tr>
                                    <th width="30%" class="text-muted">Mahasiswa</th>
                                    <td width="5%">:</td>
                                    <td class="fw-bold">Contoh Data Mahasiswa</td>
                                </tr>
                                <tr>
                                    <th width="30%" class="text-muted">Username</th>
                                    <td width="5%">:</td>
                                    <td class="fw-bold">Contoh Data Username</td>
                                </tr>
                                <tr>
                                    <th width="30%" class="text-muted">Password</th>
                                    <td width="5%">:</td>
                                    <td class="fw-bold">Contoh Data Password</td>
                                </tr>
                                <tr>
