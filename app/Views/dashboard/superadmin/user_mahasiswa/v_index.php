        ...
        <div class="card shadow-sm">
            ...
            <div class="card-body">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex gap-1 justify-content-center">
                                                <a href="<?= base_url('superadmin/user-mahasiswa/edit/' . $row['id_user_mahasiswa']) ?>" class="btn btn-sm btn-warning text-white" title="Edit"><i class="fas fa-edit"></i></a>
                                                <button type="button" class="btn btn-sm btn-danger btn-hapus" data-id="<?= $row['id_user_mahasiswa'] ?>" data-bs-toggle="modal" data-bs-target="#deleteModal" title="Hapus"><i class="fas fa-trash"></i></button>
                                            </div>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                ...
                <div class="row align-items-center mt-3">
                    <div class="col-md-6">
                        <p class="mb-0 text-muted small">Menampilkan 1 hingga 3 dari 3 entri</p>
                    </div>
