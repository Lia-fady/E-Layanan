                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex gap-1 justify-content-center">
                                                <a href="<?= base_url('superadmin/instansi_pendidikan/edit/' . $row['id_instansi_pendidikan']) ?>" class="btn btn-sm btn-warning text-white" title="Edit"><i class="fas fa-edit"></i></a>
                                                <button type="button" class="btn btn-sm btn-danger btn-hapus" data-id="<?= $row['id_instansi_pendidikan'] ?>" data-bs-toggle="modal" data-bs-target="#deleteModal" title="Hapus"><i class="fas fa-trash"></i></button>
                                            </div>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
