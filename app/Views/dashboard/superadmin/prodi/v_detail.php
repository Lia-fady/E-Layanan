...
<?= $this->section('title') ?><?= esc($title ?? 'prodi detail') ?><?= $this->endSection() ?>
    ...
    <div class="container-fluid">
        <div class="card shadow-sm">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h3 class="card-title mb-0"><i class="fas fa-info-circle me-2 text-info"></i> Informasi Lengkap Program Studi</h3>
                <div class="card-tools ms-auto">
                    <a href="<?= base_url('superadmin/prodi/edit/1') ?>" class="btn btn-success btn-sm">
                ...
                <div class="row">
                    <div class="col-md-8">
                        <table class="table table-borderless table-sm">
                            <tbody>
                                <tr>
                                    <th width="30%" class="text-muted">Fakultas</th>
                                    <td width="5%">:</td>
                                    <td class="fw-bold">Contoh Data Fakultas</td>
                                </tr>
                                <tr>
