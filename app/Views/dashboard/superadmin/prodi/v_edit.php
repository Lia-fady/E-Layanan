...
<?= $this->section('title') ?><?= esc($title ?? 'prodi edit') ?><?= $this->endSection() ?>
                    ...
                    <div class="row">
                        <div class="col-lg-8">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="fakultas" name="fakultas" placeholder="Masukkan Fakultas" value="Contoh Data Fakultas" required>
