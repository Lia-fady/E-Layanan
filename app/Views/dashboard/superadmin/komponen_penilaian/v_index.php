        ...
        <div class="card shadow-sm">
            ...
            <div class="card-body">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex gap-1 justify-content-center">
                                                <a href="<?= base_url('superadmin/komponen_penilaian/edit/' . $row['id_komponen_penilaian']) ?>" class="btn btn-sm btn-warning text-white" title="Edit"><i class="fas fa-edit"></i></a>
                                                <button type="button" class="btn btn-sm btn-danger btn-hapus" data-id="<?= $row['id_komponen_penilaian'] ?>" data-bs-toggle="modal" data-bs-target="#deleteModal" title="Hapus"><i class="fas fa-trash"></i></button>
                                            </div>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                ...
                <div class="row align-items-center mt-3">
                    <div class="col-md-6">
                        <p class="mb-0 text-muted small">Menampilkan 1 hingga 8 dari 8 entri</p>
                    </div>
