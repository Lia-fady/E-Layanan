...
<?= $this->section('title') ?><?= esc($title ?? 'komponen_penilaian edit') ?><?= $this->endSection() ?>
...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0">Edit Komponen Penilaian</h1>
            </div>
            <div class="col-sm-6">
    ...
    <div class="container-fluid">
        <div class="card shadow-sm">
            <div class="card-header">
                <h3 class="card-title">Form Edit Komponen Penilaian</h3>
            </div>
                    ...
                    <div class="row">
                        <div class="col-lg-8">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="nama_komponen" name="nama_komponen" placeholder="Masukkan Nama Komponen" value="Contoh Data Nama Komponen" required>
