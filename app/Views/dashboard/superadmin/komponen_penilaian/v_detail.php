...
<?= $this->section('title') ?><?= esc($title ?? 'komponen_penilaian detail') ?><?= $this->endSection() ?>
...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0">Detail Komponen Penilaian</h1>
            </div>
            <div class="col-sm-6">
    ...
    <div class="container-fluid">
        <div class="card shadow-sm">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h3 class="card-title mb-0"><i class="fas fa-info-circle me-2 text-info"></i> Informasi Lengkap Komponen Penilaian</h3>
                <div class="card-tools ms-auto">
                    <a href="<?= base_url('superadmin/komponen-penilaian/edit/1') ?>" class="btn btn-success btn-sm">
                ...
                <div class="row">
                    <div class="col-md-8">
                        <table class="table table-borderless table-sm">
                            <tbody>
                                <tr>
                                    <th width="30%" class="text-muted">Nama Komponen</th>
                                    <td width="5%">:</td>
                                    <td class="fw-bold">Contoh Data Nama Komponen</td>
                                </tr>
                                <tr>
