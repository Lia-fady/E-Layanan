...
<?= $this->section('title') ?><?= esc($title ?? 'kuota edit') ?><?= $this->endSection() ?>
    ...
    <div class="container-fluid">
        <div class="card shadow-sm">
            <div class="card-header">
                <h3 class="card-title">Form Edit Kuota</h3>
            </div>
            <form action="#" method="post">
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-8">
                            <div class="mb-3">
                                <label for="bidang" class="form-label fw-bold">Bidang <span class="text-danger">*</span></label>
                                <input type="text" class="form-control" id="bidang" name="bidang" placeholder="Masukkan Bidang" value="Contoh Data Bidang" required>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="jumlah_kuota" name="jumlah_kuota" placeholder="Masukkan Jumlah Kuota" value="Contoh Data Jumlah Kuota" required>
                                <!-- Contoh validasi error -->
                                <div class="invalid-feedback d-block text-danger d-none">
