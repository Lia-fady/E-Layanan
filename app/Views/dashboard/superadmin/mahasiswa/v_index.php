                                    ...
                                    <tr>
                                        ...
                                        <td class="col-aksi">
                                            <div class="d-flex gap-1 justify-content-center">
                                                ...
                                                <button type="button" class="btn btn-sm btn-danger btn-hapus" data-id="<?= $row['id_mahasiswa'] ?>" data-bs-toggle="modal" data-bs-target="#deleteModal" title="Hapus"><i class="fas fa-trash"></i></button>
                                            </div>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
