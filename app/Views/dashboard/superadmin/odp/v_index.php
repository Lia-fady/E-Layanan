            ...
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-striped table-hover align-middle">
                        ...
                        <tbody>
                            <?php if (!empty($odpList)) : ?>
                                <?php foreach ($odpList as $key => $row) : ?>
                                    <tr>
                                        ...
                                        <td class="col-aksi">
                                            <div class="d-flex gap-1 justify-content-center">
                                                <a href="<?= base_url('superadmin/odp/edit/' . $row['id_opd']) ?>" class="btn btn-sm btn-warning text-white" title="Edit"><i class="fas fa-edit"></i></a>
                                                <button type="button" class="btn btn-sm btn-danger btn-hapus" data-id="<?= $row['id_opd'] ?>" data-bs-toggle="modal" data-bs-target="#deleteModal" title="Hapus"><i class="fas fa-trash"></i></button>
                                            </div>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
