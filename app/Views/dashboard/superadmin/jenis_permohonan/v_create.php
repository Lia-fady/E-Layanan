...
<?= $this->section('title') ?><?= esc($title ?? 'jenis_permohonan create') ?><?= $this->endSection() ?>
...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0">Tambah Jenis Permohonan</h1>
            </div>
            <div class="col-sm-6">
    ...
    <div class="container-fluid">
        <div class="card shadow-sm">
            <div class="card-header">
                <h3 class="card-title">Form Tambah Jenis Permohonan</h3>
            </div>
            <form id="formTambah" action="<?= base_url('superadmin/jenis-permohonan/store') ?>" method="post">
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-8">
                            <div class="mb-3">
                                <label for="nama_jenis_permohonan" class="form-label fw-bold">Nama Jenis Permohonan <span class="text-danger">*</span></label>
                                <input type="text" class="form-control" id="nama_jenis_permohonan" name="jenis_permohonan" placeholder="Masukkan Nama Jenis Permohonan"  required>
                                <!-- Contoh validasi error -->
                                <div class="invalid-feedback d-block text-danger d-none">
                                    Nama Jenis Permohonan wajib diisi.
                                </div>
                            </div>
            ...
            success: function(response) {
                if(response.success) {
                    Swal.fire({
                        ...
                        window.location.href = "<?= base_url('superadmin/jenis-permohonan') ?>";
                    });
                } else {
                    Swal.fire({
                        icon: 'error',
