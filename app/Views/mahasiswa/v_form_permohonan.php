...
<div class="mb-4">
    ...
    <p class="text-muted mb-0"> Lengkapi data dan dokumen yang diperlukan untuk mengajukan permohonan. Periksa kembali data Anda sebelum mengirimkan permohonan.</p>
</div>
...
<div class="wizard-card text-center py-5">
    ...
    <?php if (isset($permohonan_aktif['status_persetujuan']) && $permohonan_aktif['status_persetujuan'] == 'DISETUJUI'): ?>
        ...
        <?php else: ?>
            ...
            <p class="text-muted mx-auto mb-4" style="max-width:400px;">Berkas permohonan Anda telah selesai diperiksa dan dinyatakan sesuai. Permohonan Anda telah diteruskan untuk proses persetujuan. Silakan pantau halaman status secara berkala.</p>
        <?php endif; ?>
    <?php else: ?>
...
<div class="alert mb-4 border-0 shadow-sm" style="background-color: #0f4c75; color: #e0f2fe; border-radius: 8px; padding: 18px 24px;">
    <div class="fw-bold mb-2" style="font-size: 1rem; color: #ffffff;">
        <i class="bi bi-info-circle-fill me-2"></i>Panduan Pemilihan Jenis Permohonan
    </div>
    <div style="font-size: 0.85rem; line-height: 1.5;">
        <p class="mb-2" style="opacity: 0.9;">Pilih layanan akademik yang sesuai dengan tujuan pengajuan Anda. Kesalahan pemilihan jenis layanan dapat menyebabkan permohonan ditolak:</p>
        <ul class="mb-0 ps-3" style="list-style-type: disc;">
            <li class="mb-1"><strong style="color: #ffffff;">Magang:</strong> Diperuntukkan bagi <b>Mahasiswa</b> perguruan tinggi yang ingin melaksanakan program magang kerja industri, magang mandiri, atau program kampus di lingkup instansi.</li>
            <li class="mb-1"><strong style="color: #ffffff;">Praktik Kerja Lapangan (PKL):</strong> Diperuntukkan secara khusus bagi <b>Siswa SMK/SMA sederajat</b> untuk melaksanakan kewajiban praktik kerja lapangan dari sekolah.</li>
            <li class="mb-1"><strong style="color: #ffffff;">Skripsi / Tugas Akhir:</strong> Pengajuan izin untuk melakukan wawancara, observasi mendalam, atau pengambilan riset data instansi sebagai syarat penyusunan skripsi.</li>
            <li class="mb-1"><strong style="color: #ffffff;">Observasi / Pengambilan Data:</strong> Kunjungan insidental atau pengambilan data dasar instansi untuk keperluan pemenuhan tugas mata kuliah umum pada pertengahan semester.</li>
            <li><strong style="color: #ffffff;">Uji Coba Aplikasi Produk:</strong> Permohonan izin implementasi, instalasi, atau pengujian kelayakan sistem/aplikasi buatan akademisi di lingkungan Dinas Kominfo.</li>
        </ul>
    </div>
</div>
    ...
    <div class="wizard-card wizard-step is-active" id="step-1">
        ...
        <div class="row g-3 mb-3">
            <div class="col-md-6">
                ...
                <input type="date" class="wz-form-control <?= $errMulai ? 'is-invalid' : '' ?>" name="tgl_mulai" id="tgl_mulai" value="<?= old('tgl_mulai') ?>" required style="background-color: #fff;">
                <?php if($errMulai): ?>
            ...
            <div class="col-md-6">
                ...
                <input type="date" class="wz-form-control <?= $errSelesai ? 'is-invalid' : '' ?>" name="tgl_selesai" id="tgl_selesai" value="<?= old('tgl_selesai') ?>" required style="background-color: #fff;">
                <?php if($errSelesai): ?>
        ...
        <div class="mb-4">
            ...
            <textarea class="wz-form-control" name="deskripsi" id="deskripsi" rows="4" placeholder="Jelaskan maksud, tujuan, atau rencana kegiatan yang ingin Anda ajukan..." required maxlength="1000" oninput="countChars(this,'cc-magang')"><?= old('deskripsi') ?></textarea>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (tglMulai && tglSelesai) {
        ...
        setTimeout(function() {
            ...
            // (redundant radio listener removed)
        }, 100); // 100ms delay
    }
});
</script>
