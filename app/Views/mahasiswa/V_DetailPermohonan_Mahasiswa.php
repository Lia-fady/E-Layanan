...
<div class="tw-container">
    ...
    <div class="tw-item">
        ...
        <div style="margin-top: 16px; margin-bottom: 8px;">
            <a href="<?= base_url('mahasiswa/permohonan/edit/'.$p['id_permohonan_magang']) ?>" class="btn btn-warning text-dark fw-bold px-4 py-2" style="border-radius: 8px; box-shadow: 0 4px 6px -1px rgba(245, 158, 11, 0.2); display: inline-block;">
    ...
    ?>
    <div class="tw-item">
        <div class="tw-avatar kabid <?= $isRevisiSekre ? 'disabled' : '' ?>" title="Kepala Bidang">KB</div>
        
        <div class="tw-header">
            <div class="tw-header-text">
                <span class="tw-header-actor">Kepala Bidang</span> <?= $kHeader ?>
                <span class="tw-header-time">
        ...
        <div class="tw-card">
            ...
            <div class="tw-attachment-note" <?= $isKabidBatal ? 'style="padding-top: 18px;"' : '' ?>>
                <span style="display: block; color: #6b7280; font-size: 0.8rem; margin-bottom: 2px;">Catatan Kepala Bidang:</span>
                <?= nl2br(esc($p['catatan'])) ?>
            </div>
            <?php endif; ?>
        </div>
