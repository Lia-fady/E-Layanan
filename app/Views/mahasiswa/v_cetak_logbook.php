                ...
                <?php if (!empty($logbook)): ?>
                    <?php $no = 1; foreach ($logbook as $row): ?>
                        <tr>
                            ...
                            <td>
                                <?php $activityTime = \App\Helpers\LogbookTimeHelper::formatActivityDateTime($row['tgl_logbook'] ?? null); ?>
                                <div><?= esc($activityTime['date']) ?></div>
                                <?php if (!empty($activityTime['time'])): ?>
                                    <div style="font-size: 0.85rem; color: #666;"><?= esc($activityTime['time']) ?></div>
                                <?php endif; ?>
                            </td>
