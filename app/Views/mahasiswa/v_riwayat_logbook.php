                            ...
                            <tbody>
                                <?php if(!empty($logbook)): ?>
                                    ...
                                    <tr>
                                        ...
                                        <td class="fw-semibold text-secondary" style="font-size: 0.82rem; line-height: 1.4;">
                                            <?php $activityTime = \App\Helpers\LogbookTimeHelper::formatActivityDateTime($l['tgl_logbook'] ?? null); ?>
                                            <div><?= esc($activityTime['date']) ?></div>
                                            <?php if (!empty($activityTime['time'])): ?>
                                                <div class="text-muted small mt-1"><?= esc($activityTime['time']) ?></div>
                                            <?php endif; ?>
                                        </td>
