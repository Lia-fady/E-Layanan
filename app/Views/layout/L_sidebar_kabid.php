...
<ul class="navbar-nav sidebar sidebar-dark-navy sidebar-dark accordion d-flex flex-column" id="accordionSidebar">
    ...
    <!-- Nav Item - Riwayat Disposisi Magang -->
    <li class="nav-item <?= (isset($active_menu) && $active_menu == 'riwayat_selesai') ? 'active' : '' ?>">
        <a class="nav-link" href="<?= base_url('kabid/riwayat-selesai') ?>">
