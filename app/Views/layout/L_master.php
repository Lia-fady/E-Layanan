...
/**
 * Kode    : L_master.php
 * Path    : app/Views/layout/L_master.php
 * Deskripsi : Template layout utama (master) menggunakan SB Admin 2.
 *             Menyediakan struktur HTML lengkap termasuk sidebar, navbar,
 *             area konten dinamis, footer, modal logout, dan tombol scroll to top.
 *             Digunakan sebagai parent layout untuk semua halaman modul Sekretariat.
 */
?>
<!DOCTYPE html>
<html lang="id">
