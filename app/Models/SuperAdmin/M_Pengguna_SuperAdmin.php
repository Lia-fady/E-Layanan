...
class M_Pengguna_SuperAdmin extends Model
{
    ...
    protected $allowedFields    = ['nama', 'nip', 'password', 'kode_unor', 'id_user_group', 'id_bidang', 'status_aktif', 'file_tanda_tangan', 'last_login'];
