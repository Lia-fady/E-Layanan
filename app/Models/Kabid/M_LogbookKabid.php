...
class M_LogbookKabid extends Model
{
    ...
    public function getMahasiswaInfo($id_penempatan)
    {
        return $this->db->table('t_penempatan_magang p')
            ->select('p.id_penempatan_magang, p.status_penempatan, m.nama_mahasiswa, m.nim, m.jenis_kelamin, m.no_telp, m.email, ip.instansi_pendidikan, pr.nama_prodi as prodi, pm.tgl_mulai, pm.tgl_selesai')
            ...
            ->join('m_mahasiswa m', 'm.id_mahasiswa = pm.id_mahasiswa', 'left')
