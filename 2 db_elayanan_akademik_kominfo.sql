...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 31 Jul 2026 pada 08.59
...
(23, '2026-07-21-020000', 'App\\Database\\Migrations\\CreateFileProsesMagang', 'default', 'App', 1784600074, 5),
(24, '2026-07-21-030000', 'App\\Database\\Migrations\\AlterFileProsesMagang', 'default', 'App', 1784603916, 6);
...
INSERT INTO `m_bidang` (`id_bidang`, `bidang`, `status_aktif`, `id_opd`, `kuota_total`) VALUES
(1, 'Bidang Infrastruktur TIK', '1', 1, 10),
(2, 'Bidang Diseminasi Informasi Dan Komunikasi Publik', '1', 1, 100),
(3, 'Bidang Sarana, Prasarana TIK dan Persandian', '1', 1, 100),
(4, 'Bidang Statistik Dan Pemberdayaan TIK', '1', 1, 10),
(5, 'Bidang Pengembangan E-Goverment', '1', 1, 10);
...
(3, '3671020222040055', '10204230011', 'Refa Dias Perkedel PSHT', 'P', '2005-01-03', 'JL RAYA PRIOK NO 5', '01', '04', 'Priuk', 'Priuk', 'Banten', '081218501097', 3, 'refapsht@gmail.com', '2026-07-20 04:38:14', '2026-07-20 04:38:14'),
(4, '3671020222040011', '10204230001', 'Refa Psht', 'P', '2005-03-02', 'JL RAYA PRIOK JAYA NO 5', '01', '04', 'Priuk', 'Priuk', 'Banten', '081218501063', 4, 'refapsht02@gmail.com', '2026-07-21 01:16:10', '2026-07-21 01:16:10'),
(5, '3671070707070707', '2210102003', 'Ahmad Abdillah Hisyam', 'L', '2003-12-07', 'Gg.Raden Kimas Hasyim', '002', '003', 'Karawaci', 'Karawaci', 'Banten', '080808080808080', 5, 'ahmadhisyam443@gmail.com', '2026-07-28 07:35:47', '2026-07-28 07:35:47');
...
--
-- Dumping data untuk tabel `m_user_mahasiswa`
--
...
(3, 3, 'Refapsht', '$2y$10$NVwfFPoS9p3BlkglP3E4FOQDE.3n0KcuBs4mDiXubT.hubUs4xzzu', 'AKTIF', '2026-07-20 04:38:14', '2026-07-20 04:38:14'),
(4, 4, 'Refapsht02', '$2y$10$fOS/xExDivT7mD2mXr.5YOGRPdEuCZAno8/dZL6BQG4pz2/0n/QXC', 'AKTIF', '2026-07-21 01:16:10', '2026-07-21 01:16:10'),
(5, 5, 'Ahmad', '$2y$12$wwiuYqjgxkmJvHIw08nqcOFH8KGbEoqwgVPduxguqBDmGADI/QHOG', 'AKTIF', '2026-07-28 07:35:48', '2026-07-28 07:35:48');
...
--
-- Dumping data untuk tabel `t_file_permohonan_magang`
--

INSERT INTO `t_file_permohonan_magang` (`id_file_permohonan_magang`, `id_permohonan_magang`, `id_file_permohonan`, `nama_file`, `path_file`, `status_verifikasi`, `created_at`, `updated_at`) VALUES
(14, 4, 4, 'trial balance.pdf', 'uploads/dokumen/1784352144_f52bbbaa3a859798fadb.pdf', 'VALID', '2026-07-18 05:22:24', NULL),
(15, 4, 5, 'Journal_JICT.pdf', 'uploads/dokumen/1784352144_3caf9d6db426e648137e.pdf', 'VALID', '2026-07-18 05:22:24', NULL),
(30, 13, 4, 'Kertas Kerja 1 - Revisi.pdf', 'uploads/dokumen/1784596782_7f3339c8591c10678482.pdf', 'VALID', '2026-07-21 01:19:42', NULL),
(31, 13, 5, 'Kertas Kerja 1 - Metodologi-Identifikasi Kebutuhan-Teknik Elisitasi-Kosong v1_Day 2.pdf', 'uploads/dokumen/1784596782_f5de59df718609a317f9.pdf', 'VALID', '2026-07-21 01:19:42', NULL),
(34, 15, 4, '833-contoh-jurnal-mooc-pppk.pdf', 'uploads/dokumen/1784897760_26e9473864cb47410d36.pdf', 'VALID', '2026-07-24 12:56:00', NULL),
(35, 15, 5, 'Halaman pengesahan.pdf', 'uploads/dokumen/1784897760_92e05778d0bf312ea858.pdf', 'VALID', '2026-07-24 12:56:00', NULL);
...
CREATE TABLE `t_file_proses_magang` (
  ...
  `proses_magang` enum('persetujuan','selesai') DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Dumping data untuk tabel `t_file_proses_magang`
--

INSERT INTO `t_file_proses_magang` (`id_file_selesai_magang`, `id_persetujuan_magang`, `jenis_dokumen`, `id_file`, `nama_file`, `path_file`, `catatan`, `created_at`, `created_by`, `updated_at`, `updated_by`, `proses_magang`) VALUES
(8, 10, NULL, 8, 'Halaman pengesahan.pdf', 'uploads/surat_penerimaan_magang/1784605101_07ccaadd00fe2d466527.pdf', NULL, '2026-07-21 02:34:43', '1', '2026-07-21 03:38:21', '1', 'persetujuan'),
(18, 5, NULL, 8, 'Halaman pengesahan.pdf', 'uploads/surat_penerimaan_magang/1784782859_f9b4e5218a8f35e40dab.pdf', NULL, '2026-07-22 07:34:17', '1', '2026-07-23 05:00:59', '1', 'persetujuan');
...
--
-- Dumping data untuk tabel `t_instansi_mahasiswa`
--
...
(3, 3, 3, 6, 9, 'S1', '2023', '7', '2025/2026', 'SYSTEM_REGISTRATION', NULL, NULL, NULL),
(4, 4, 1, 1, 2, 'S1', '2023', '6', '2025/2026', 'SYSTEM_REGISTRATION', NULL, NULL, NULL),
(5, 5, 1, 1, 2, 'S1', '2022', '8', '2026/2027', 'SYSTEM_REGISTRATION', NULL, NULL, NULL);
...
--
-- Dumping data untuk tabel `t_penempatan_magang`
--
...
(5, 5, 10, 4, 'Disposisi dari Verifikasi', 'BERJALAN', 'ya', '2026-07-21 01:21:58', '1', '2026-07-28 03:11:27', '5', NULL),
(12, 5, 5, 1, 'Disposisi dari Verifikasi', 'BERJALAN', 'ya', '2026-07-27 02:10:18', '1', '2026-07-28 02:28:01', '5', NULL),
(13, 5, 13, 2, 'Disposisi dari Verifikasi', 'BERJALAN', 'ya', '2026-07-27 02:10:26', '1', '2026-07-28 03:11:57', '5', NULL);
...
--
-- Dumping data untuk tabel `t_permohonan_magang`
--

INSERT INTO `t_permohonan_magang` (`id_permohonan_magang`, `id_mahasiswa`, `id_instansi_mahasiswa`, `id_jenis_permohonan`, `deskripsi_keahlian`, `deskripsi`, `tgl_mulai`, `tgl_selesai`, `posting_data`, `created_at`, `updated_at`) VALUES
...
(13, 4, 4, 3, 'Php, Java, Python, Html, Css', 'Pengembangan aplikasi Berbasis Websiter', '2026-07-21', '2026-09-19', 'kirim', '2026-07-21 01:19:42', NULL),
(15, 2, 2, 3, 'tessssssssssssssssssssssssssssssssssssssssssssssssssssssssssssss', 'tessssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssss', '2026-07-24', '2026-09-22', 'kirim', '2026-07-24 12:56:00', NULL);
...
CREATE TABLE `t_persetujuan_magang` (
  ...
  `id_permohonan_magang` int(11) UNSIGNED NOT NULL,
  `catatan` text DEFAULT NULL,
  `status_persetujuan` enum('MENUNGGU','DISETUJUI','PERBAIKAN_BERKAS') NOT NULL DEFAULT 'MENUNGGU',
  `created_at` datetime DEFAULT NULL,
  `created_by` varchar(100) DEFAULT NULL,
  `updated_at` datetime DEFAULT NULL,
  `updated_by` varchar(100) DEFAULT NULL,
...
--
-- Dumping data untuk tabel `t_persetujuan_magang`
--
...
(5, 4, 'Semua berkas valid', 'DISETUJUI', '2026-07-21 08:30:59', '3', '2026-07-28 02:11:43', '1', '1', 5, '2026-07-28'),
(10, 13, 'Semua berkas valid', 'DISETUJUI', '2026-07-21 08:31:09', '1', '2026-07-27 02:10:35', '1', '1', 5, '2026-07-27'),
(13, 15, 'Semua berkas valid', 'DISETUJUI', NULL, '1', '2026-07-27 03:18:39', '1', '1', 5, '2026-07-27');
...
(1, 'Superadmin', '1', '2026-07-27 01:56:19', NULL, NULL, NULL),
(2, 'Bidang Seketariat', '1', '2026-07-27 01:56:19', NULL, NULL, NULL),
(3, 'Bidang E-Gov', '1', '2026-07-27 01:56:19', NULL, NULL, NULL);
...
ALTER TABLE `t_file_proses_magang`
  ...
  ADD KEY `t_file_selesai_magang_id_penempatan_magang_foreign` (`id_persetujuan_magang`),
...
--
ALTER TABLE `m_file`
  MODIFY `id_file` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
...
--
ALTER TABLE `m_kuota`
  MODIFY `id_kuota` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=27;

--
-- AUTO_INCREMENT untuk tabel `m_mahasiswa`
--
ALTER TABLE `m_mahasiswa`
  MODIFY `id_mahasiswa` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
ALTER TABLE `m_user_mahasiswa`
  MODIFY `id_user_mahasiswa` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT untuk tabel `t_file_permohonan_magang`
--
ALTER TABLE `t_file_permohonan_magang`
  MODIFY `id_file_permohonan_magang` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=39;

--
-- AUTO_INCREMENT untuk tabel `t_file_proses_magang`
--
ALTER TABLE `t_file_proses_magang`
  MODIFY `id_file_selesai_magang` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;

--
-- AUTO_INCREMENT untuk tabel `t_instansi_mahasiswa`
--
ALTER TABLE `t_instansi_mahasiswa`
  MODIFY `id_instansi_mahasiswa` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
ALTER TABLE `t_penempatan_magang`
  MODIFY `id_penempatan_magang` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
...
--
ALTER TABLE `t_permohonan_magang`
  MODIFY `id_permohonan_magang` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;

--
-- AUTO_INCREMENT untuk tabel `t_persetujuan_magang`
--
ALTER TABLE `t_persetujuan_magang`
  MODIFY `id_persetujuan_magang` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
...
--
ALTER TABLE `t_file_proses_magang`
  ADD CONSTRAINT `fk_file_persetujuan_magang` FOREIGN KEY (`id_persetujuan_magang`) REFERENCES `t_persetujuan_magang` (`id_persetujuan_magang`) ON DELETE CASCADE ON UPDATE CASCADE,
